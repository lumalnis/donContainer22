...
$(function () {
  var numberOfItems = $(".cardProduct-content .cardProduct").length;
  ...
  function showPage(whichPage) {
    ...
    $(".cardProduct-content .cardProduct").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
